...
### Perform enrichment
# Ctrl + Alt + E
#gmt_file <- "../pathways/GO_Cellular_Component_2025.txt"
#gmt_file <- "../pathways/MSigDB_Hallmark_2020.txt"
#gmt_file <- "../pathways/Reactome_Pathways_2024.txt"
#gmt_file <- "../pathways/MGI_Mammalian_Phenotype_Level_4_2024.txt"
#gmt_file <- "../pathways/SysMyo_Muscle_Gene_Sets.txt"
gmt_file <- "../pathways/KEGG_2021_Human.txt"
gmt_file <- "../pathways/GO_Biological_Process_2025.txt"
gmt_file <- "../pathways/GO_Molecular_Function_2025.txt"
gmt_file <- "../pathways/Jensen_COMPARTMENTS.txt"
...
dotplot(ora_res, showCategory=10, title=NULL)

pname = sapply(strsplit(gmt_file,"/"), `[`,3)
pname = sapply(strsplit(pname,".txt"), `[`, 1)

ggsave(paste0("../plots/ora/ora_dot_S",segment,"_",pname,"_p001_lfc05.png"), width = 9, height = 8, scale = 0.8, dpi = 100)
...
ggsave(paste0("../plots/ora/ora_heat_S",segment,"_",pname,"_p001_lfc05.png"), width = 15, height = 7, scale = 0.8, dpi = 100)
